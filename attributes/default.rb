...
default['hw']['smartsense']['config']['activity-zeppelin-shiro']['users.admin'] = 'admin'
default['hw']['storm']['user']['name'] = 'storm'
default['hw']['storm']['user']['home'] = '/home/storm'
default['hw']['storm']['user']['shell'] = '/bin/bash'
default['hw']['storm']['user']['uid'] = '15028'
